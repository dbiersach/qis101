...
"""electrical_conductivity_macos_chrome.py"""
...
# Optional: specify Chrome path if needed (uncomment below if you get an error)
...
# options.binary_location = chrome_path  # Uncomment if Chrome is not found automatically

# Initialize WebDriver using webdriver-manager (auto handles download)
